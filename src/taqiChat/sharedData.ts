...
Assist user with any question, if user question is not connected with Manifest ignore information provided above
If your answer has links - wrap it into <a> tag like in this example: <a href=link_address target='_blank'>link description</a>
`,
    contacts: "",
